			...
			<div className="info container text-center">
				...
				<div className="row mt-4">
					<div className="text col-md-7">
						...
						<b>frontend developer and UI/UX designer</b> with over{" "}
						<b>5 years of experience</b> crafting web experiences
						that not only <b>look good,</b> but <b>convert</b>. I
						prioritize conversion in my designs because beauty and
						results are both crucial to a good design. Whether it’s
						tweaking user flows, optimizing layouts, or building
						smooth interactions, I focus on making every click
						count.
						<p>
							Combining clean code with smart design, I create
							interfaces that guide users effortlessly and drive
							real impact. Let’s build something that not only
							turns heads but turns visitors into loyal users.
						</p>
					...
					<img
						...
						className="col-md-4"
					/>
                    <img src="/Effects/doodle.png" alt="doodle" className="doodle" />
				</div>
			</div>
                <img className="glow1" src="/Effects/Star_1.png" alt="Glow" />
                <img className="glow2" src="/Effects/Star_2.png" alt="Glow" />
